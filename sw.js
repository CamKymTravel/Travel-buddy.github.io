...
const CACHE='travel-buddy-v1-0.10.1';
const PRECACHE=['./','./index.html','./manifest.webmanifest','./styles.css','./app.js','./db.js','./logic.js','./country-data.js','./travel-buddy-pink-180.png','./travel-buddy-pink-192.png','./travel-buddy-pink-512.png'];
